...
router.post("/add",uploadFile.single("image"), AdminBlogController.createBlog)
router.patch("/update/:id",uploadFile.single("image"), AdminBlogController.updateBlogById)
